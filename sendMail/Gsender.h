...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "YnJldXNlbWFub3VhbmFlc2dpQGdtYWlsLmNvbQ==";
        const char* EMAILBASE64_PASSWORD = "bWVtb2lyZWVzZ2k=";
        const char* FROM = "breusemanouanaesgi@gmail.com";
